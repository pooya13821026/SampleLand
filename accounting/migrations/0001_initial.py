    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='user_avatar', verbose_name='بارگزاری تصویر پروفایل')),
                ...
                ('biography', models.TextField(blank=True, db_index=True, null=True, verbose_name='بیوگرافی')),
